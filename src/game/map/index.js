...
const MAP_CONFIG = {
  '低级地图': {
    ...
    pokemonPool: [
      '波波', '小拉达', '绿毛虫', '独角虫', '鲤鱼王', '烈雀',
      '比比鸟', '派拉斯', '派拉斯特', '毛球', '末入蛾',
      '超音蝠', '小拳石', '喵喵', '胖丁', '皮皮', '毒刺水母', '玛瑙水母',
      '喇叭芽', '走路草', '地鼠', '穿山鼠', '尼多兰', '尼多朗'
    ],
    itemPool: ['普通精灵球', '伤药'],
    silverPoints: [],
    goldPoints: [],
  ...
  '中级地图': {
    ...
    pokemonPool: [
      '比比鸟', '大嘴雀', '拉达', '穿山王', '尼多力诺', '尼多娜', '尼多后', '尼多王',
      '皮皮', '皮可西', '六尾', '九尾', '胖丁', '胖可丁', '超音蝠', '大嘴蝠',
      '小拳石', '隆隆石', '隆隆岩', '地鼠', '三地鼠', '喵喵', '猫老大',
      '可达鸭', '哥达鸭', '猴怪', '火爆猴', '蚊香蝌蚪', '蚊香君', '蚊香泳士',
      '凯西', '勇基拉', '胡地', '鬼斯', '鬼斯通', '耿鬼', '大岩蛇'
    ],
  ...
  '高级地图': {
    ...
    pokemonPool: [
      '雷电球', '顽皮雷弹', '椰蛋树', '肯泰罗', '风速狗', '蚊香泳士', '快泳蛙',
      '毒刺水母', '宝石海星', '角金鱼', '金鱼王', '海刺龙', '墨海马', '飞天螳螂',
      '迷唇姐', '电击兽', '鸭嘴火兽', '巨钳蟹', '大钳蟹', '派拉斯特', '末入蛾',
      '大比鸟', '大嘴雀', '胖可丁', '九尾', '胡地', '耿鬼', '隆隆岩', '三地鼠',
      '猫老大', '哥达鸭', '火爆猴', '大岩蛇', '铁甲暴龙', '超铁暴龙', '化石翼龙'
    ],
  ...
  '终极高危地图': {
    ...
    pokemonPool: [
      '卡比兽', '急冻鸟', '闪电鸟', '火焰鸟', '超梦', '梦幻', '化石翼龙', '袋兽',
      '三地鼠', '吉利蛋', '乘龙', '百变怪', '喷火龙', '水箭龟', '妙蛙花',
      '快龙', '超铁暴龙', '巨钳蟹', '风速狗', '肯泰罗', '椰蛋树', '飞天螳螂',
      '宝石海星', '耿鬼', '胡地', '九尾', '胖可丁', '大比鸟', '铁甲贝', '多刺菊石兽', '镰刀盔'
    ],
